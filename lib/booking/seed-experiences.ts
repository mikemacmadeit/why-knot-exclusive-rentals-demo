...
const EXPERIENCES: (Omit<Experience, "id"> & { _rates: RateSeed[] })[] = [
  {
    ...
    subtitle: `${siteConfig.catalog.halfDay.durationLabel} · Bareboat or add a captain`,
    descriptionLong:
      "Be your own captain and explore the Florida Keys at your own pace — sandbars, sightseeing, or a lazy day on the water. Captain optional.",
    ...
    location: {
      ...
      notes: "Arrive a little early for parking and loading. We'll confirm the exact dock after you book.",
    },
    maxGuests: 12,
    petsMax: 0,
    ...
    faqs: [
      {
        ...
        a: "No for boat rentals — you can be your own captain. Add a USCG-licensed captain if you’d rather not drive.",
      },
      { q: "What should we bring?", a: "Sunscreen, sunglasses, hat, soft-soled shoes, snacks and drinks." },
    ],
    ...
    tagline: FOUNDING_ANGLER_RATE_ACTIVE ? FOUNDING_ANGLER_LABEL : "Boat Rental",
    _rates: halfDayRates(),
  },
  {
    slug: "watersports",
    ...
    descriptionLong:
      "Offshore, reef & wreck, or backcountry fishing in the Florida Keys. USCG-licensed captain included. Trip plan customized to conditions and your experience level.",
    heroMedia: { type: "image", url: "/photos/whyknot/catch-swordfish.jpg" },
    gallery: [
  ...
  },
  {
    ...
    subtitle: "Half or full day · The Bougie Girl experience",
    descriptionLong:
      "Luxury sandbar and snorkel in the Florida Keys. Designed for comfort, with a captain handling every detail. Ask about The Bougie Girl or the Sea Fox 26.8 Commander.",
    heroMedia: { type: "image", url: "/photos/whyknot/sandbar-cheers.jpg" },
    gallery: [
    ...
    faqs: [
      {
        ...
        a: "We depart Tavernier Creek in Tavernier, Florida Keys. Exact dock details come after you book.",
      },
      {
        q: "Do I need a captain?",
        a: "Sandbar and snorkel trips include a USCG-licensed captain.",
      },
    ],
    seasonal: { enabled: false },
    active: true,
    ...
    fromPriceCents: getActiveCatalogRateCents("half"),
    sortOrder: 2,
    metaTitle: `${siteConfig.catalog.allIn.title} | Florida Keys`,
    metaDescription: `Book ${siteConfig.catalog.allIn.title} — private captained charter. ${brand.companyName}.`,
    tagline: "Luxury Sandbar & Snorkel",
    _rates: [
      { durationHours: 4, displayName: "Half day (4 Hours)", priceCents: getActiveCatalogRateCents("half"), active: true },
      { durationHours: 6, displayName: "6 Hours", priceCents: 95_000, active: true },
      { durationHours: 8, displayName: "Full day (8 Hours)", priceCents: getActiveCatalogRateCents("full"), active: true },
    ],
  },
  {
    slug: "holiday",
    ...
    heroMedia: { type: "image", url: "/photos/whyknot/catch-lobsters.jpg" },
    gallery: ["/photos/whyknot/catch-lobsters.jpg", siteConfig.media.boats, "/photos/whyknot/sandbar-cheers.jpg"],
    location: {
      title: "Tavernier Creek",
      addressText: siteConfig.contact.marinaMeetNote,
    },
